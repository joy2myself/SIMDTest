...
void test_eve(ankerl::nanobench::Bench &bench, ElemType x0,
              ElemType y0,
              ElemType x1,
              ElemType y1,
              int width,
              ...
              std::vector<ElemType> _buf)
{
  MANDELBROT_SIMD<eve_t_v_native<ElemType>, eve_t_m_native<ElemType>, ElemType> func;
  bench.minEpochIterations(ITERATION).run("eve", [&]() {
