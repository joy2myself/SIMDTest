...
int main()
{
  ...
  // maxPooling2D
  CONV_SIMD<std_simd_t_v_native<int>, int>{}.maxPooling2D(X, kernel_size, stride, "VALID");

  // conv2D
  CONV_SIMD<std_simd_t_v_native<int>, int>{}.conv2D(X, w, kernel_size, stride, "VALID");
